...
public class Main {
    public static void main(String[] args) {
        ...
        Player pPlayer = new Player("Martin", "Mage");
        Player ppPlayer = new Player("Martin", "Mage");
        ...
        guild.addPlayer(pPlayer);
        guild.addPlayer(ppPlayer);

        guild.promotePlayer("Martin");
        guild.demotePlayer("Martin");
        //Promote player
